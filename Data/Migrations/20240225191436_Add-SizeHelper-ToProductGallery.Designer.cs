...
namespace Data.Migrations
{
    ...
    [Migration("20240225191436_Add-SizeHelper-ToProductGallery")]
    partial class AddSizeHelperToProductGallery
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.AboutUs.AboutUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.Discount.DiscountCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.Discount.DiscountCodeSelectedFromUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DiscountCodeSelectedUsers");
                });

            modelBuilder.Entity("Domain.Models.FavoriteProducts.FavoriteProducts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.Order.Orders", b =>
                {
                    ...
                    b.Property<int?>("DiscountUserSelected")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Product.ProductCategories", b =>
                {
                    ...
                    b.Property<bool>("ShowInPart1")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowInPart2")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Models.Product.ProductColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ColorFarsiTitle")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.Product.ProductSelectedColors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProductSelectedColors");
                });

            modelBuilder.Entity("Domain.Models.Product.ProductSelectedSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ProductsSizeId");

                    b.ToTable("ProductSelectedSizes");
                });

            modelBuilder.Entity("Domain.Models.Product.ProductsSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.UserCommentAboutSite.UsersCommentsAboutSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UsersCommentsAboutSites");
                });
            ...
            modelBuilder.Entity("Domain.Models.Wallet.WalletData", b =>
                {
                    b.Property<int>("WalletDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Domain.Models.Product.ProductSelectedColors", b =>
                {
                    b.HasOne("Domain.Models.Product.ProductColor", "ProductColor")
            ...
            modelBuilder.Entity("Domain.Models.Product.ProductSelectedSize", b =>
                {
                    b.HasOne("Domain.Models.Product.Product", "Product")
                        .WithMany("ProductSelectedSizes")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.Product.ProductsSize", "ProductsSize")
                        .WithMany("ProductSelectedSizes")
                        .HasForeignKey("ProductsSizeId");

                    b.Navigation("Product");

                    b.Navigation("ProductsSize");
                });
            ...
            modelBuilder.Entity("Domain.Models.Wallet.WalletData", b =>
                {
                    b.HasOne("Domain.Models.Wallet.Wallet", "Wallet")
                        .WithOne("WalletData")
                        .HasForeignKey("Domain.Models.Wallet.WalletData", "WalletId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.Product.Product", b =>
                {
                    ...
                    b.Navigation("ProductSelectedSizes");
                });
