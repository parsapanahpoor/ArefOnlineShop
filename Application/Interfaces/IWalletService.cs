...
namespace Application.Services.Interfaces
{
    public interface IWalletService
    {
        ...
        Task CreateNewWalletTransactionForRedirextToTheBankPortal(int userId, int price, GatewayType gateway, string authority, string description, ulong? requestId);
